...
const Player = ({ msg, settrfsong ,setvisible}) => {
  ...
  return (
    <div className="myDiv lg:bg-black/60 h-[70vh] bg-white md:p-2 p-2 w-full lg:w-[82%]   lg:block  fixed z-0 lg:top-[50%] lg:rounded-xl lg:h-1/2 top-[7%] text-white overflow-y-scroll">
